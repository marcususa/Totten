...
class PatternsInitMixin:
    """Mixin responsible for building the complete UI shell and layout for PatternsAnalysis."""

    def _safe_load_game_from_state(self, game_node, category_source=None):
        """Ignores non-patterns callbacks to prevent cross-view pollution."""
    ...
    def init_layout(self):
        if hasattr(state, "register_analysis_callback"):
            state.register_analysis_callback(self._safe_load_game_from_state)
